...
nerd_fonts=(
    ...
    "IosevkaTerm https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/IosevkaTerm.zip"
    "IosevkaTermMono https://github.com/ryanoasis/nerd-fonts/releases/download/v2.1.0/IosevkaTermMono.zip"
)
